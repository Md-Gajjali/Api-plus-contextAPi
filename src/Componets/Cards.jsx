...
const Cards = ({rating,title,imgSrc,price}) => {
    return (
        <div>
            <div className="w-full max-w-sm mt-30 container m-auto bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs">
                <a href="#">
                    <img className="rounded-base mb-6" src={imgSrc} alt="product image" />
                </a>
                <div>
